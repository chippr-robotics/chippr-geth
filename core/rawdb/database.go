...
func NewDatabaseWithFreezerRemote(db ethdb.KeyValueStore, freezerURL string) (ethdb.Database, error) {
	...
	// chippr-geth: The validation below is the original and contemporary upstream
	// ethereum/go-ethereum implementation of validations in NewDatabaseWithFreezer. chippr-geth's
